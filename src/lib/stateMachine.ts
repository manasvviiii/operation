...
export const TRANSITION_MAP: TransitionMap = {
  ...
  AWAITING_BANK: ['AWAITING_INCORPORATION', 'FAILED', 'CANCELLED', 'PAUSED'],
  AWAITING_INCORPORATION: ['AWAITING_AGREEMENT', 'FAILED', 'CANCELLED', 'PAUSED'],
  AWAITING_AGREEMENT: ['VALIDATING', 'FAILED', 'CANCELLED', 'PAUSED'],
